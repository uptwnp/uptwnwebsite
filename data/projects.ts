...
export const projects: Project[] = [
  ...
  },
  {
    ...
    amenities: ['Swimming pool', 'Gym', 'Jogging Track', 'Yoga Garden', 'Lawn Tennis Court', 'Basketball Court', 'Banquet Lawn', 'Kids play area', 'Multipurpose hall'],
    specifications: {
  ...
  },
  {
    ...
    specifications: {
      ...
      Possession: 'Dec 2026',
      Approval: 'RERA (Under Process / Coming Soon for "Emperium Panipat" projects)',
    },
    gallery: [
  ...
  },
  {
    ...
    specifications: {
      ...
      Approval: 'HRERA-PKL-PROJ-1259-2023, HRERA-PKL-PNP-523-2023, HRERA-PKL-PNP-446-2023',
    },
    gallery: [
      'https://images.pexels.com/photos/1546166/pexels-photo-1546166.jpeg?auto=compress&cs=tinysrgb&w=800',
    ],
  },
  {
    ...
    location: 'Village Mauli & Sarakpur, Panchkula (near Panipat, NH‑07 corridor)',
    type: 'Commercial',
  ...
  },
  {
    ...
    specifications: {
      ...
      'Price Range': '₹52–78 L',
      Approval: 'RERA (Century 21st Real Estate Mentor is a RERA registered agent)',
    },
    gallery: [
      'https://images.pexels.com/photos/1370296/pexels-photo-1370296.jpeg?auto=compress&cs=tinysrgb&w=800',
    ],
