...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    title: 'Nysa Residential',
    location: 'Shimla Maulana Road, Panipat',
    segment: 'Residential',
    form: 'Plots',
    type: 'Plots',
    status: 'On Sale · 10 left',
    price: '₹1.00 Cr',
    area: '18 acres',
    units: 'Limited plots',
    possession: 'Ready',
    total: '18 acres',
    description: 'Premium gated plotted colony on Shimla Maulana Road with very limited availability — only 10 plots remaining.',
    details: [
      'An 18-acre gated plotted colony on Shimla Maulana Road with only 10 plots remaining at ₹1.00 Cr.',
      'The development features boundary walls, internal roads, landscaped entry, and 24x7 security.',
    ],
    features: ['Only 10 plots remaining', 'Gated colony', 'Premium location', 'Ready possession'],
    amenities: ['Boundary wall', 'Internal roads', 'Landscaped entry', '24x7 security'],
    nearby: ['Shimla Maulana Road'],
    specifications: {
      'Total area': '18 acres',
      'Price': '₹1.00 Cr',
      'Possession': 'Ready',
